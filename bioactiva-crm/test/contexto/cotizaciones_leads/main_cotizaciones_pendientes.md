...
Secion: aqui se debería ver una cotizacion nueva cuando se acaba de crear un lead el cual lo movemos (con drag and drop) desde la seccion "EN PROSPECTO" a la seccion de "OFERTADO"
    ...
    >
      <div class="overflow-x-auto">
        ...
        hover:bg-gray-50"
            >
              <td class="px-4 py-3">
                <p class="text-sm font-bold text-gray-600">COT-2026-014</p>
        ...
        hover:bg-gray-50"
            >
              <td class="px-4 py-3">
                <p class="text-sm font-bold text-gray-600">COT-2026-002</p>
                <div class="sm:hidden mt-1 space-y-0.5">
                  <p class="text-xs text-gray-500">jun. 2026</p>
      ...
      >
        <p class="text-sm text-gray-500">Mostrando 1–2 de 2</p>
      </div>
    </div>
  </div>
</main>
